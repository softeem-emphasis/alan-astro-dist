...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recipient_email = "info@softeem.ca"; // <-- IMPORTANT: Replace with your email address
    // Set the subject of the email
    $subject = "New Contact Form Submission from Softeem Website";
    ...
    $headers = [];
    $headers[] = "From: Softeem Contact Form <noreply@softeem.ca>";
